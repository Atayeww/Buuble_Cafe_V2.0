<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Panel/AdminPanel.Master" AutoEventWireup="true" CodeBehind="BookEdit.aspx.cs" Inherits="Bubble_Cafe.Admin_Panel.BookEdit" ValidateRequest="false"%>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="frame">
        <h3 class="target">Kitap Düzenle</h3>
        <asp:Panel ID="pnl_success" runat="server" Visible="false" CssClass="success">Kitap Düzenleme Başarılı</asp:Panel>
        ...
        <div style="float: right; width:49%;">
            ...
            <div class="raw">
                <asp:Image ID="img_image" runat="server" Width="300px"/>
            </div>
            <div class="raw">
                <asp:FileUpload ID="fu_addimage" runat="server"/>
            </div>
            <div class="raw" style="padding-top:40px;">
                <asp:LinkButton ID="lbtn_editBook" runat="server" CssClass="editLinkButton" OnClick="lbtn_editBook_Click">Kitap Düzenle</asp:LinkButton>
            </div>
        </div>
    </div>
</asp:Content>
